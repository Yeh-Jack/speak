...
const topics = [
  { id: 'daily', label: 'Daily Conversation', icon: 'M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z' },
  { id: 'business', label: 'Business English', icon: 'M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z' },
  { id: 'travel', label: 'Travel & Tourism', icon: 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z' },
  { id: 'academic', label: 'Academic Discussion', icon: 'M12 14l9-5-9-5-9 5 9 5z M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z' },
];
    ...
    <main class="container mx-auto px-4 py-8">
      <div class="mb-8">
        ...
        <p class="text-learning-text-secondary">
          Improve your pronunciation with AI-powered shadowing and speech recognition
        </p>
      </div>
          ...
          <div class="bg-learning-surface rounded-xl border border-learning-bg-tertiary p-6 mb-6">
            ...
            <div class="flex flex-col items-center justify-center py-12 bg-learning-bg-primary rounded-xl">
              ...
              <p class="text-learning-text-muted text-sm mt-2">
                Practice speaking for at least 30 seconds
              </p>
            </div>
          </div>
          ...
          <div class="bg-learning-surface rounded-xl border border-learning-bg-tertiary p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div class="p-4 bg-learning-bg-primary rounded-lg">
                ...
                <h3 class="font-medium text-learning-text-primary mb-1">Shadowing</h3>
                <p class="text-sm text-learning-text-muted">Listen and repeat immediately after hearing</p>
              </div>
              <div class="p-4 bg-learning-bg-primary rounded-lg">
                ...
                <h3 class="font-medium text-learning-text-primary mb-1">Focus on Fluency</h3>
                <p class="text-sm text-learning-text-muted">Don't worry about mistakes, keep talking</p>
              </div>
              <div class="p-4 bg-learning-bg-primary rounded-lg">
                ...
                <h3 class="font-medium text-learning-text-primary mb-1">Record Yourself</h3>
                <p class="text-sm text-learning-text-muted">Listen back to identify areas to improve</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="text-center py-6">
              <div class="relative w-32 h-32 mx-auto mb-4">
                ...
                <div class="absolute inset-0 flex flex-col items-center justify-center">
                  ...
                  <span class="text-xs text-learning-text-muted">of 15 min</span>
                </div>
              </div>

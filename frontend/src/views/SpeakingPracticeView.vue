...
const practiceHistory = ref([
  { id: '1', title: 'Ordering Coffee', date: '2026-06-02', score: 85, duration: '3:45' },
  { id: '2', title: 'Job Interview', date: '2026-06-01', score: 78, duration: '5:20' },
]);

const topics = computed(() => [
  { id: 'daily', label: t('Daily Conversation', '日常對話'), icon: 'M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z' },
  { id: 'business', label: t('Business English', '商務英語'), icon: 'M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z' },
  { id: 'travel', label: t('Travel & Tourism', '旅遊'), icon: 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z' },
  { id: 'academic', label: t('Academic Discussion', '學術討論'), icon: 'M12 14l9-5-9-5-9 5 9 5z M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z' },
]);
    ...
    <main class="container mx-auto px-4 py-8">
      <div class="mb-8">
        <h1 class="text-3xl font-bold font-display text-learning-text-primary mb-2">
          {{ t('Speaking Practice', '口說練習') }}
        </h1>
        <p class="text-learning-text-secondary">
          {{ t('Improve your pronunciation with AI-powered shadowing and speech recognition', '使用 AI 驅動的跟讀和語音辨識提升發音') }}
        </p>
      </div>
          ...
          <div class="bg-learning-surface rounded-xl border border-learning-bg-tertiary p-6 mb-6">
            ...
            <div class="flex flex-col items-center justify-center py-12 bg-learning-bg-primary rounded-xl">
              ...
              <p class="text-learning-text-secondary text-center">
                {{ isRecording ? t('Recording... Speak now!', '錄音中... 請說話！') : t('Click to start recording', '點擊開始錄音') }}
              </p>
              <p class="text-learning-text-muted text-sm mt-2">
                {{ t('Practice speaking for at least 30 seconds', '練習說話至少 30 秒') }}
              </p>
            </div>
          </div>
          ...
          <div class="bg-learning-surface rounded-xl border border-learning-bg-tertiary p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div class="p-4 bg-learning-bg-primary rounded-lg">
                ...
                <h3 class="font-medium text-learning-text-primary mb-1">{{ t('Shadowing', '跟讀') }}</h3>
                <p class="text-sm text-learning-text-muted">{{ t('Listen and repeat immediately after hearing', '聽完立即重複') }}</p>
              </div>
              <div class="p-4 bg-learning-bg-primary rounded-lg">
                ...
                <h3 class="font-medium text-learning-text-primary mb-1">{{ t('Focus on Fluency', '專注流利度') }}</h3>
                <p class="text-sm text-learning-text-muted">{{ t("Don't worry about mistakes, keep talking", '不要擔心錯誤，繼續說') }}</p>
              </div>
              <div class="p-4 bg-learning-bg-primary rounded-lg">
                ...
                <h3 class="font-medium text-learning-text-primary mb-1">{{ t('Record Yourself', '錄下自己的聲音') }}</h3>
                <p class="text-sm text-learning-text-muted">{{ t('Listen back to identify areas to improve', '回聽以找出需改進之處') }}</p>
              </div>
            </div>
          </div>
        </div>
